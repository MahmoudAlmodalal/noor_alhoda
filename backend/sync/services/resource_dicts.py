...
def teacher_to_dict(t: Teacher) -> dict[str, Any]:
    return {
        ...
        "birthdate": _iso(t.birthdate) if t.birthdate else None,
        "marital_status": t.marital_status or "",
        "education_qualification": t.education_qualification or "",
        "last_tajweed_course": t.last_tajweed_course or "",
        "family_members_count": t.family_members_count,
...
def student_to_dict(s: Student) -> dict[str, Any]:
    return {
        ...
        "bank_account_number": s.bank_account_number or None,
        "bank_account_name": s.bank_account_name or None,
        "bank_account_type": s.bank_account_type or None,
        "teacher_id": str(s.teacher_id) if s.teacher_id else None,
        "affiliation": s.teacher.affiliation if s.teacher else "",
        ...
        "last_course_reached": s.last_course_reached or "",
...
def daily_record_to_dict(r: DailyRecord) -> dict[str, Any]:
    return {
        ...
        "quality": r.quality,
        "morals_rating": r.morals_rating,
        "scattered_test_score": r.scattered_test_score,
        "combined_test_score": r.combined_test_score,
        "note": r.note,
        "result": r.result,
