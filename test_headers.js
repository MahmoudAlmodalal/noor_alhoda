function classifyHeader(h, counters) {
  h = String(h || "").trim();
  if (!h) return null;
...
const headersStr = "مالاسم رباعي رقم الهوية تاريخ الميلاد العمر الصف الدراسي رقم الجوال رقم الواتساب عنوان السكن الحالة الخاصه المهارات الدورات السابقة الاسم رباعي رقم الهوية رقم الحوال رقم الحساب اسم الحساب نوع الحساباسم الشيخ التباعيه ";
