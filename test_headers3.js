...
const txt = `البيانتات الشخصية بيانات ولي الامر الحساب البنكي 
مالاسم رباعي رقم الهوية تاريخ الميلاد العمر الصف الدراسي رقم الجوال رقم الواتساب عنوان السكن الحالة الخاصه المهارات الدورات السابقة الاسم رباعي رقم الهوية رقم الحوال رقم الحساب اسم الحساب نوع الحساباسم الشيخ التباعيه `;
...
console.log(bestMap.map((m, i) => `${aoa[headerRowIdx][i].trim()} => ${m}`).join("\n"));
